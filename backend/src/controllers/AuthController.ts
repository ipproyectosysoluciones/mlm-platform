...
export const registerValidation = [
  ...
  body('sponsor_code')
    .optional()
    .isString()
    .withMessage('Sponsor code must be a string'),
];
 ...
 */
export const register: RequestHandler = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 */
export const login: RequestHandler = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 */
export const me: RequestHandler = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  ...
  if (fullUser.sponsorId) {
    ...
    sponsor = sponsorUser
      ? { id: sponsorUser.id, referralCode: sponsorUser.referralCode }
      : null;
  }
