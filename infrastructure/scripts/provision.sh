...
# Handles: Google Calendar (schedule visits), Notion CRM (leads), human handoff
# UI available at http://localhost:5678 (local only — do NOT expose publicly)
N8N_HOST=localhost
N8N_PROTOCOL=http
N8N_USER_EMAIL=REPLACE_WITH_N8N_EMAIL
N8N_USER_PASSWORD=REPLACE_WITH_N8N_PASSWORD
N8N_USER_FIRST_NAME=Nexo
N8N_USER_LAST_NAME=Admin

# ── n8n — Google Calendar ────────────────────────────────────────────────────
# Credentials configured via n8n UI (see docs/N8N-SETUP.md)
GOOGLE_CALENDAR_ID=

# ── n8n — Notion CRM ────────────────────────────────────────────────────────
# Credentials configured via n8n UI
NOTION_DATABASE_ID_LEADS=
NOTION_DATABASE_ID_VISITS=

# ── n8n — Brevo Human Handoff ────────────────────────────────────────────────
SALES_TEAM_EMAIL=
