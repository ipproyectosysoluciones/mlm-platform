  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 px-4 pb-4 pointer-events-none">
      <div className="max-w-2xl mx-auto pointer-events-auto">
        <div className="flex items-center justify-between gap-4 px-5 py-3 rounded-2xl bg-[var(--color-card)]/95 backdrop-blur-xl border border-[var(--color-border)]/60 shadow-2xl shadow-black/30">
          {/* Position info */}
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="text-[var(--color-foreground-muted)] text-xs mt-0.5">posición</p>
            </div>
