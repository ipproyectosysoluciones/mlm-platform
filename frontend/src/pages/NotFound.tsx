    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-secondary)] p-4">
      <div className="text-center">
        ...
        <div className="relative mb-8">
          <h1 className="text-[120px] lg:text-[180px] font-bold text-[var(--color-foreground-muted)] leading-none select-none">
            404
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          <Link
            to="/dashboard"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--color-card)] text-white font-medium rounded-xl hover:bg-[var(--color-card)] transition-colors"
          >
