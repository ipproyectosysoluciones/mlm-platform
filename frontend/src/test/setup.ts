...
const mockT = (key: string, _options?: Record<string, unknown>) => {
  const translations: Record<string, string> = {
    ...
    'dashboard.subtitle': 'Tu panel de control',
    'dashboard.stats.pending': 'Pendientes',
    'dashboard.myNetwork': 'Mi Red',
    'dashboard.directReferrals': 'Referidos Directos',
    'dashboard.totalNetwork': 'Red Total',
    'dashboard.referralLink': 'Link de Referido',
    'dashboard.showQR': 'Mostrar QR',
    'dashboard.hideQR': 'Ocultar QR',
    'dashboard.recentCommissions': 'Comisiones Recientes',
    'dashboard.recentReferrals': 'Referidos Recientes',
    'dashboard.commissions': 'Comisiones',
    'dashboard.noCommissions': 'Sin comisiones',
    'dashboard.noCommissionsHint': 'Cuando recibas comisiones, aparecerán aquí.',
    'dashboard.noReferrals': 'Sin referidos',
    'dashboard.noReferralsHint': 'Cuando tus referidos se activen, aparecerán aquí.',
    'dashboard.commissionBreakdown': 'Desglose de Comisiones',
    'dashboard.commissionByLevel': 'Nivel',
    'dashboard.rate': 'Tasa',
    'dashboard.referrals': 'Referidos',
    'dashboard.earnings': 'Ganancias',
    'dashboard.totalEarnings': 'Ganancias Totales',
    'dashboard.level': 'Nivel {n}',
    'dashboard.bonuses': 'Bonos',
    ...
    'reservation.mpVendorNotConnected':
    ...
    'checkout.payWithMercadoPago': 'Pagar con MercadoPago',
    'checkout.mpError': 'No se pudo crear la preferencia de pago. Por favor intentá de nuevo.',
    'checkout.mpVendorNotConnected': 'El negocio aún no conecta MercadoPago.',
    'checkout.paymentToBusinessAccount': 'El pago se realizará a la cuenta del negocio.',
    'common.cancel': 'Cancelar',
    'products.loading': 'Cargando productos...',
    'products.error': 'Error al cargar productos',
    'products.days': 'días',
    'wallet.allTypes': 'Todos',
    'wallet.commissions': 'Comisiones',
    'wallet.withdrawals': 'Retiros',
    'wallet.refunds': 'Reembolsos',
    'wallet.transactions': 'Transacciones',
    'wallet.loadMore': 'Cargar más',
    'wallet.noWallet': 'Sin wallet',
    'wallet.availableBalance': 'Balance Disponible',
    'wallet.ready': 'Listo',
    'wallet.lastUpdated': 'Actualizado',
    'wallet.balance': 'Wallet Balance',
    'wallet.clickToView': 'Click para ver detalles →',
  };
